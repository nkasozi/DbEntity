...
namespace DbEntity
{
    internal static class DbInitializerCore
    {
        //find all types that inherit from ActiveRecordBase
        //using reflection
        internal static DbResult AutoFindTypesToKeepTrackOf()
        {
            ...
            try
            {
                ...
                DbInitializer.TypesToKeepTrackOf.AddRange(types_that_inherit_from_activeRecord);
        ...
        internal static DbResult SetConnectionStringInDatabaseHandler()
        {
            DbResult dbResult = new DbResult();
        ...
        internal static DbResult CreateStoredProcedures()
        {
            ...
            try
            {
                ...
                DbInitializer.IsInitOfStoredProcSuccessfull = true;
        ...
        internal static DbResult ExecuteCreateDatabaseSQLIfNotExists()
        {
            DbResult apiResult = new DbResult();
        ...
        internal static DbResult ExecuteDropDatabaseSQLIfExists()
        {
            DbResult apiResult = new DbResult();
        ...
        internal static string ReadConnectionFromConfig()
        {
